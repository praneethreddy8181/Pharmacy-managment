...
function addMedicine() {
  ...
  if (!notNull(name.value, "medicine_name_error")) {
    ...
    xhttp.open("POST", "php/add_new_medicine.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");

    // Send the data in the request body
    xhttp.send(
      "name=" + encodeURIComponent(name.value) +
      "&packing=" + encodeURIComponent(packing.value) +
      "&generic_name=" + encodeURIComponent(generic_name.value) +
      
      "&batch_id=" + encodeURIComponent(batch_id.value) +
      "&exp_date=" + encodeURIComponent(exp_date.value) +
      "&suppliers_name=" + encodeURIComponent(suppliers_name.value) +
      "&quantity=" + encodeURIComponent(quantity.value) +
      "&mrp=" + encodeURIComponent(mrp.value) +
