<?php
  ...
  function printInvoice($invoice_number) {
    ...
    if($con) {
      ...
      $customer_name = isset($row['NAME']) ? $row['NAME'] : 'N/A';
      $address = isset($row['ADDRESS']) ? $row['ADDRESS'] : 'N/A';
      $contact_number = isset($row['CONTACT_NUMBER']) ? $row['CONTACT_NUMBER'] : 'N/A';
      $doctor_name = isset($row['DOCTOR_NAME']) ? $row['DOCTOR_NAME'] : 'N/A';
      $doctor_address = isset($row['DOCTOR_ADDRESS']) ? $row['DOCTOR_ADDRESS'] : 'N/A';
    ...
    if($con) {
      ...
      // Debugging: Print out fetched values
